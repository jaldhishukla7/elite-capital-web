        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-base text-[#6B7280] dark:text-[#9CA3AF] leading-relaxed">
              Live market data, real-time charts, watchlist trackers, Futures & Options insights — everything you need to make informed investment decisions.
            </p>
