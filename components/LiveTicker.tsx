...
const FALLBACK_ITEMS: TickerItem[] = [
  { id: '^NSEI', symbol: '^NSEI', name: 'NIFTY 50', price: 23487.50, change: 125.40, changePercent: 0.54, isIndex: true },
  { id: '^BSESN', symbol: '^BSESN', name: 'SENSEX', price: 77123.45, change: 312.50, changePercent: 0.41, isIndex: true },
  { id: 'NIFTYJUNIOR', symbol: 'NIFTYJUNIOR', name: 'NIFTY JR', price: 69820.30, change: -45.60, changePercent: -0.07, isIndex: true },
...
export function LiveTicker() {
  ...
  useEffect(() => {
    ...
    const desiredSymbols = ['^NSEI', '^BSESN', 'NIFTYJUNIOR', 'NIFTYMIDCAP150', 'NIFTY500', 'GOLD', 'SILVER', 'CRUDE']
    const filtered = combined.filter(item => desiredSymbols.includes(item.symbol))
    
    // Sort in preferred display order: NIFTY 50, SENSEX, NIFTY JR, NIFTY MIDCAP 150, NIFTY 500, GOLD, SILVER, CRUDE OIL
