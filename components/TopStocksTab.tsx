              ...
              {currentItems.map((item, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`grid grid-cols-3 md:grid-cols-4 px-6 py-4 items-center transition-colors duration-300 ${flashClass}`}
                  >
                    {/* Name */}
                    <div className="col-span-1 md:col-span-2 min-w-0 pr-4">
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-[#1A1A1A] dark:text-white text-sm whitespace-nowrap">
                          {item.symbol}
                        </span>
                        {isPositive ? (
