          ...
          <div className="grid gap-3 md:gap-4">
            {filteredStocks.length === 0 ? (
              ...
              filteredStocks.map((stock: any) => (
                <div
                  key={stock.symbol}
                  className="p-4 bg-white dark:bg-[#1A1A1A] border border-[#E8E8E8] dark:border-[#2A2A2A] rounded-lg hover:shadow-md transition-shadow cursor-pointer"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-[#6B7280] dark:text-[#9CA3AF]">
                        Vol: {formatVolume(stock.volume)} | Market Cap: {stock.marketCap || 'N/A'}
                      </p>
                    </div>
